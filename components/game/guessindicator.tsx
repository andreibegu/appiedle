...
export default function GuessIndicator({ closeness, direction }: IndicatorProps) {
    ...
    return (
        <div className={clsx(`w-20 pl-6 pr-6 h-8 border-solid border-2 rounded-md flex items-center justify-center`,
            {
